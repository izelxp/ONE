/*
 * Clase que representa el mazo principal de cartas
 * 
 * Funcionalidad:
 * - Inicializa el mazo con 76 cartas (4 colores × 19 cartas)
 * - Baraja las cartas aleatoriamente
 * - Permite tomar cartas del mazo
 * - Reconstruye el mazo desde el descarte cuando se agota
 */
package uno;
